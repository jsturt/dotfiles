...
_G.packer_plugins = {
  ["better-digraphs.nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/better-digraphs.nvim",
  ...
  ["neogruvbox.nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/neogruvbox.nvim",
  ...
  ["vim-closer"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/vim-closer",
